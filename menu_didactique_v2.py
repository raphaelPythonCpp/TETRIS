...
class Menu_didactique(object):
    def __init__(self, jeu, police, horloge, lNomsConstantes, nbParties, avecTorch):
        self.jeu = jeu
        self.police = police
    ...
    def evaluation(self):
        ...
        self.changer_resultats(scoreMoyen, nbCoupsMoyen)
    ...
    def changer_resultats(self, scoreMoyen, nbCoupsMoyen):
        self.texteScoreMoyen = self.generateurTexte.creer_surface_texte(f"{scoreMoyen:.2f}", 0.3*self.jeu.wF, 0.1*self.jeu.hF, 0.05)
        self.positionTexteScoreMoyen = (0.6*self.jeu.wF, 0.3*self.jeu.hF)
        self.texteNbCoupsMoyen = self.generateurTexte.creer_surface_texte(f"{nbCoupsMoyen:.2f}", 0.3*self.jeu.wF, 0.1*self.jeu.hF, 0.05)
